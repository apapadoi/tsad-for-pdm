...
if METRIC == 'AD1_AUC':
    technique_to_best_flavor = { #_ad1_auc
        'CHRONOS': '_onl',      # Online flavor
        'IF': '_sli',           # Sliding flavor  
        'KNN': '_sli',          # Sliding flavor
        'LOF': '_onl',          # Online flavor
        'LTSF': '_onl',         # Online flavor
        'NP': '_uns',           # Unsupervised flavor
        'OCSVM': '_onl',        # Online flavor
        'PB': '_sli',           # Sliding flavor
        'TRANAD': '_onl',       # Online flavor
        'USAD': '_onl',          # Online flavor
        'SAND': '_uns',
        'ALL': '_uns',
        'ADD': '_onl',
        'XGBOOST': ''
    ...
    technique_to_best_flavor = { # _VUS_PR
        'CHRONOS': '_onl',      # Online flavor (mean rank: 1.1111)
        'IF': '_onl',           # Online flavor (mean rank: 1.5000)
        'KNN': '_onl',          # Online flavor (mean rank: 1.6000)
        'LOF': '_onl',          # Online flavor (mean rank: 1.2000)
        'LTSF': '_onl',         # Online flavor (mean rank: 1.4000)
        'NP': '_uns',           # Unsupervised flavor (mean rank: 1.7000)
        'OCSVM': '_onl',        # Online flavor (mean rank: 1.1000)
        'PB': '_onl',           # Online flavor (mean rank: 1.3000)
        'TRANAD': '_onl',       # Online flavor
        'USAD': '_onl',          # Online flavor (mean rank: 1.4000)
        'SAND': '_uns',
        'ALL': '_uns',
        'ADD': '_onl',
        'XGBOOST': ''
