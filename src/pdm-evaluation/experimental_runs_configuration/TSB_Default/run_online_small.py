...
def execute(method_names_to_run, MAX_RUNS=100, MAX_JOBS=16, INITIAL_RANDOM=4, setup_1_predict=100, setup_1_early=10, max_sizes=None):
    ...
    for dataset_name in dataset_names_to_run:
        ...
        experiment_names = [
            f'TSB {max_sizes} Auto profile {dataset_name} moment',
        ]
        ...
        param_space_dict_per_method = [
            automatic_parameter_generation.online_technique(method_name, dataset["max_wait_time"]) for method_name in method_names]
        ...
        for current_method, current_method_param_space, current_method_name in zip(methods, param_space_dict_per_method, method_names):
            ...
            for experiment, experiment_name in zip(experiments, experiment_names):
                ...
                current_param_space_dict['profile_size'] = automatic_parameter_generation.profile_values(dataset["max_wait_time"], moment='ForecastingAnomalyPrediction' == current_method_name)
                ...
                my_experiment = experiment(
                    ...
                    constraint_function=auto_profile_max_wait_time_constraint(my_pipeline) if current_method_name != 'ForecastingAnomalyPrediction' else None,
                    debug=True,
