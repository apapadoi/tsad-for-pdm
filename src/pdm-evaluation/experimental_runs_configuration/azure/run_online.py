...
"""This is a telemetry time-series data.\
 It consists of voltage, rotation, pressure, and vibration measurements collected from 100 machines\
 in real time averaged over every hour collected during the year 2015."""
        ]

        param_space_dict_per_method[-1]['batch_size'] = [128]
    ...
    for current_method, current_method_param_space, current_method_name in zip(methods, param_space_dict_per_method,
        ...
        for experiment, experiment_name in zip(experiments, experiment_names):
            ...
            if current_method_name == 'TIMEMIXERPP':
                ...
                current_method_param_space['moving_avg'] = [35]
                current_method_param_space['seq_len'] = [148]
