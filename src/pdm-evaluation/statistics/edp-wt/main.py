...
if sys.argv[1] == 'statistics':
    directory = '../../DataFolder/edp-wt/'
else:
    directory = '../../DataFolder/edp-wt/scenarios'
...
for root, dirs, files in os.walk(directory):
    for file in files:
        if file.endswith('.csv'):
            ...
            list_of_dimensions.append(df.shape[1] - 1) # do not consider the Τimestamp column
