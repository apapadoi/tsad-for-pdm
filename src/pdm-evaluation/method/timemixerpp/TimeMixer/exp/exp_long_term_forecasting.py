...
from method.timemixerpp.TimeMixer.utils.tools import EarlyStopping, adjust_learning_rate, visual, save_to_csv, visual_weights
from method.timemixerpp.TimeMixer.utils.metrics import metric
import torch
...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def test(self, setting, test):
        ...
        # mae, mse, rmse, mape, mspe = metric(preds_reshaped, trues_reshaped)
        # print('mse:{}, mae:{}'.format(mse, mae))

        if self.args.forecasting_distance == 'euclidean':
