...
from method.timemixerpp.TimeMixer.data_provider.data_factory import data_provider
from method.timemixerpp.TimeMixer.data_provider.m4 import M4Meta
from method.timemixerpp.TimeMixer.exp.exp_basic import Exp_Basic
from method.timemixerpp.TimeMixer.utils.tools import EarlyStopping, adjust_learning_rate, visual, save_to_csv
from method.timemixerpp.TimeMixer.utils.losses import mape_loss, mase_loss, smape_loss
from method.timemixerpp.TimeMixer.utils.m4_summary import M4Summary
import torch
...
class Exp_Short_Term_Forecast(Exp_Basic):
    def __init__(self, args, df, n_vali):
    ...
    def _get_data(self, flag):
        data_set, data_loader = data_provider(self.args, flag, self.df, self.n_vali)
