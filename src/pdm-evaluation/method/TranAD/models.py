...
# 
# This file contains modified code originally sourced from the TranAD project 
# (https://github.com/imperial-qore/TranAD).
# 
# The original TranAD code is licensed under the BSD 3-Clause License.
# See the LICENSE file in the root of this repository for the full text 
# of the BSD 3-Clause License (Appendix: Third-Party Licenses).
#
# Modifications made by Anastasios Papadopoulos & Apostolos Giannoulidis are licensed under the 
# Apache License, Version 2.0 of this project.
# ==============================================================================
...
from method.TranAD.dlutils import *
from method.TranAD.constants import *
torch.manual_seed(1)
